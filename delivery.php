...
WHERE `order`.`c_id`=customer.c_id AND `order`.`p_id`=pharmacy.p_id AND `order`.`d_id`=delivery.d_id AND `order`.`o_id`=".$o_id.";";
        ...
        if($status=="Canceled")
        {
            $sql2="UPDATE `delivery` SET `count` = `count`-1 WHERE `delivery`.`d_id` = ".$_SESSION["d_id"].";";
            ...
            mysqli_query($con,$sql3);
                    ...
                    $mail_subject = 'Order Cancellation From Delivery Agent';
                    ...
                    $email_body   .="<h2 style="."text-align:center".">Order Cancellation From Delivery Agent</h2>";
                    $email_body   .="<p style="."text-align:center".">Dear {$cname} your order has been Cancelled by the Delivery Agent.</p>";
                    ...
                    $email_body2   .="<h2 style="."text-align:center".">Order Cancellation From Delivery Agent</h2>";
                    $email_body2   .="<p style="."text-align:center".">Dear {$dname} your order has been Cancelled.</p>";
                    ...
                    $email_body3   .="<h2 style="."text-align:center".">Order Cancellation From Delivery Agent</h2>";
                    $email_body3   .="<p style="."text-align:center".">Dear {$pname} your order has been Cancelled by the Delivery Agent.</p>";
                    ...
                    $email		= 'order@healthycare.com';
                    $mail_subject = 'Order is On The Way';
                    $email_body   ="<html><head><style>";
                    $email_body   .="body{font-family:Arial;}";
                    $email_body   .=".container{height:50px;position:relative;}";
                    $email_body   .=".center{margin:0;position:absolute;top:50%;left:50%;-ms-transform:translate(-50%,-50%);transform:translate(-50%,-50%);}";
                    ...
                    $email_body   .="<div style="."background-color: white".">";
                    $email_body   .="<img src="."http://healthycare.teamcodeit.com/images/Healthy%20Care-logos_black.png"." width="."50%"." style="."display:block;margin-left:auto;margin-right:auto;".">";
                    $email_body   .="<h2 style="."text-align:center".">Order is On The Way</h2>";
                    $email_body   .="<p style="."text-align:center".">Dear {$cname} your order is On The Way. Please get ready to pay for the Pharmacy bill as well as Rs.300 as the Delivery charge.</p>";
                    $email_body   .="<table><tr><td>Order Id:</td><td>#{$o_id}</td></tr>";
                    $email_body   .="<tr><td>Order Date Time:</td><td>{$o_datetime}</td></tr>";
                    $email_body   .="<tr><td>Pharmacy Name:</td><td>{$pname}</td></tr>";
                    $email_body   .="<tr><td>Delivery Agent Name:</td><td>{$dname}</td></tr>";
                    ...
                    $email_body2   .="<div style="."background-color: white".">";
                    $email_body2   .="<img src="."http://healthycare.teamcodeit.com/images/Healthy%20Care-logos_black.png"." width="."50%"." style="."display:block;margin-left:auto;margin-right:auto;".">";
                    $email_body2   .="<h2 style="."text-align:center".">Order is On The Way</h2>";
                    $email_body2   .="<p style="."text-align:center".">Dear {$dname} thank you for updating the order as On The Way.</p>";
                    $email_body2   .="<table><tr><td>Order Id:</td><td>#{$o_id}</td></tr>";
                    $email_body2   .="<tr><td>Order Date Time:</td><td>{$o_datetime}</td></tr>";
                    $email_body2   .="<tr><td>Pharmacy Name:</td><td>{$pname}</td></tr>";
                    $email_body2   .="<tr><td>Delivery Agent Name:</td><td>{$dname}</td></tr>";
                    ...
                    $email_body3   .="<div style="."background-color: white".">";
                    $email_body3   .="<img src="."http://healthycare.teamcodeit.com/images/Healthy%20Care-logos_black.png"." width="."50%"." style="."display:block;margin-left:auto;margin-right:auto;".">";
                    $email_body3   .="<h2 style="."text-align:center".">Order is On The Way</h2>";
                    $email_body3   .="<p style="."text-align:center".">Dear {$pname} your medicine is On The Way to customers address.</p>";
                    $email_body3   .="<table><tr><td>Order Id:</td><td>#{$o_id}</td></tr>";
                    $email_body3   .="<tr><td>Order Date Time:</td><td>{$o_datetime}</td></tr>";
                    $email_body3   .="<tr><td>Pharmacy Name:</td><td>{$pname}</td></tr>";
                    $email_body3   .="<tr><td>Delivery Agent Name:</td><td>{$dname}</td></tr>";
           ...
           mysqli_query($con,$sql3);
                    ...
                    $email		= 'order@healthycare.com';
                    $mail_subject = 'Order has been Deliverd';
                    $email_body   ="<html><head><style>";
                    $email_body   .="body{font-family:Arial;}";
                    $email_body   .=".container{height:50px;position:relative;}";
                    $email_body   .=".center{margin:0;position:absolute;top:50%;left:50%;-ms-transform:translate(-50%,-50%);transform:translate(-50%,-50%);}";
                    ...
                    $email_body   .="<div style="."background-color: white".">";
                    $email_body   .="<img src="."http://healthycare.teamcodeit.com/images/Healthy%20Care-logos_black.png"." width="."50%"." style="."display:block;margin-left:auto;margin-right:auto;".">";
                    $email_body   .="<h2 style="."text-align:center".">Order has been Deliverd</h2>";
                    $email_body   .="<p style="."text-align:center".">Dear {$cname} your order has been Deliverd.</p>";
                    $email_body   .="<table><tr><td>Order Id:</td><td>#{$o_id}</td></tr>";
                    $email_body   .="<tr><td>Order Date Time:</td><td>{$o_datetime}</td></tr>";
                    $email_body   .="<tr><td>Pharmacy Name:</td><td>{$pname}</td></tr>";
                    $email_body   .="<tr><td>Delivery Agent Name:</td><td>{$dname}</td></tr>";
                    ...
                    $email_body2   .="<div style="."background-color: white".">";
                    $email_body2   .="<img src="."http://healthycare.teamcodeit.com/images/Healthy%20Care-logos_black.png"." width="."50%"." style="."display:block;margin-left:auto;margin-right:auto;".">";
                    $email_body2   .="<h2 style="."text-align:center".">Order has been Deliverd</h2>";
                    $email_body2   .="<p style="."text-align:center".">Dear {$dname} your have successfully Deliverd the order.</p>";
                    $email_body2   .="<table><tr><td>Order Id:</td><td>#{$o_id}</td></tr>";
                    $email_body2   .="<tr><td>Order Date Time:</td><td>{$o_datetime}</td></tr>";
                    $email_body2   .="<tr><td>Pharmacy Name:</td><td>{$pname}</td></tr>";
                    $email_body2   .="<tr><td>Delivery Agent Name:</td><td>{$dname}</td></tr>";
                    ...
                    $email_body3   .="<div style="."background-color: white".">";
                    $email_body3   .="<img src="."http://healthycare.teamcodeit.com/images/Healthy%20Care-logos_black.png"." width="."50%"." style="."display:block;margin-left:auto;margin-right:auto;".">";
                    $email_body3   .="<h2 style="."text-align:center".">Order has been Deliverd</h2>";
                    $email_body3   .="<p style="."text-align:center".">Dear {$pname} your order has been Deliverd to the customer.</p>";
                    $email_body3   .="<table><tr><td>Order Id:</td><td>#{$o_id}</td></tr>";
                    $email_body3   .="<tr><td>Order Date Time:</td><td>{$o_datetime}</td></tr>";
                    $email_body3   .="<tr><td>Pharmacy Name:</td><td>{$pname}</td></tr>";
                    $email_body3   .="<tr><td>Delivery Agent Name:</td><td>{$dname}</td></tr>";
...
<table class="table">
  ...
  <tbody>
      <?php 
								  ...
								  $sql2 ="SELECT `order`.`o_id`, `customer`.`c_name`, `pharmacy`.`p_name`, `pharmacy`.`p_id` ,`customer`.`c_address`,`customer`.`c_telephone`, `order`.`o_status`
                                FROM `order`, `customer`, `pharmacy`	 
                                WHERE `order`.`c_id`=`customer`.c_id AND `order`.`p_id`=`pharmacy`.`p_id` AND
                                `order`.`d_id`=".$_SESSION["d_id"]." ORDER BY `order`.`o_id` DESC;";
								  ...
								  if(mysqli_num_rows($result2)>0)
                                  {
									while($row = mysqli_fetch_assoc($result2))
									{
										...
										<td><?php $o_id=$row['o_id']; echo $o_id ?></td>
										...
										<td></td>
                                            ...
                                            <td><?php echo $status; ?></td>
                                            <td>
                                                <form style="text-align: left" action="delivery.php?o_id=<?php echo $o_id ?>&p_id=<?php echo $row['p_id']; ?>" method="post">
