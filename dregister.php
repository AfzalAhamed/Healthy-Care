  ...
  <div class="wrapper">
    <form class="form-signin" action="dregister.php" method="post">          
      <h2 class="form-signin-heading">Delivery Register</h2><br>
        ...
        <br>
      <button class="btn btn-lg btn-primary btn-block" type="submit" id="dregister" name="dregister">Register</button> <br><br>
                <p>if you alredy have an account <a href="dlogin.php"> Click Here</a></p>
    </form>
  </div>
