...
$con=mysqli_connect("localhost","root","","healthycare");
                ...
                if($password==$cpassword)
                {
                    if($email==$cemail)
                    {
                        ...
                        $sql="INSERT INTO `chanelcenter` (`ch_name`, `ch_email`, `ch_password`, `ch_telephone`, `ch_address`, `ch_town`, `ch_licence`) VALUES ('".$name."', '".$email."', PASSWORD('".$password."'), '".$telephone."', '".$address."', '".$town."', '".$br."');";
...
<head>
  ...
  <title>Channel Center | Register</title>
...
<br><br><br><br>
<div class="overlay">
  <form action="chregister.php" method="post">
   <div class="con">
   ...
   <div class="field-set">
                ...
                <input class="form-input" placeholder="Name" type="text" id="name" name="name" requird>
                <input class="form-input" placeholder="Telephone" type="text" id="telephone" name="telephone" requird>
                <input class="form-input" placeholder="Business Number" type="text" id="br" name="br" requird>
                <input class="form-input" placeholder="Email" type="email" id="email" name="email" requird>
     
                
                <input class="form-input" placeholder="Re-Email" type="email" id="cemail" name="cemail" requird>
                <input class="form-input" placeholder="Password" type="password" id="password" name="password" requird>
                 <input class="form-input" placeholder="Re-Password" type="password" id="cpassword" name="cpassword" requird>
                <input class="form-input" placeholder="Address" type="text" id="address" name="address" requird><br>
      ...
      <br>
      <button class="log-in" type="submit" id="chregister" name="chregister"> Sign Up </button>
   </div>
   <div class="other">
      <a class="btn submits sign-up" href="chlogin.php">Log In 
      </a>
   </div>
  </div>
</form>
